...
Функция РазделителиБлоков()
	...
	РазделителиБлоков.Вставить("IF", Истина);
	...
	РазделителиБлоков.Вставить("FUNCTION", Истина);
	...
	РазделителиБлоков.Вставить("RETURN", Истина);
...
Функция ЭтоУнарнаяОперация( Знач пСтрокаДоФрагмента, Знач пПредСтрока, Знач пПозицияФрагмента, Знач пФрагмент )
	...
	Для каждого цСлово Из КлючевыеСловаДляПодтвержденияУнарныхОпераций() Цикл
